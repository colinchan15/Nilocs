...
class CubesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cube" do
    assert_difference('Cube.count') do
      post cubes_url, params: { cube: { brand: @cube.brand, condition: @cube.condition, description: @cube.description, finish: @cube.finish, model: @cube.model, price: @cube.price, title: @cube.title } }
    end
  ...
  test "should update cube" do
    patch cube_url(@cube), params: { cube: { brand: @cube.brand, condition: @cube.condition, description: @cube.description, finish: @cube.finish, model: @cube.model, price: @cube.price, title: @cube.title } }
